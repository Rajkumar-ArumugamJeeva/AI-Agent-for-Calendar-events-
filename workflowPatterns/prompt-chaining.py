...
def extract_event_info(user_input: str) -> EventExtraction:
    ...
    response_json = json.loads(completion.message["content"])
    result = EventExtraction(**response_json)
    logger.info(
...
def parse_event_details(description: str) -> EventDetails:
    ...
    response_json = json.loads(completion.message["content"])
    result = EventDetails(**response_json)
    logger.info(
...
def generate_confirmation(event_details: EventDetails) -> EventConfirmation:
    ...
    response_json = json.loads(completion.message["content"])
    result = EventConfirmation(**response_json)
...
user_input = "Let's schedule a 1h team meeting next Monday at 2pm with Alice and Bob to discuss the project roadmap."
